    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?php echo base_url(); ?>assets/index2.html" class="h1"><b>Admin</b>LTE</a>
            </div>
            <div class="card-body">
                ...
                <form>
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" id="txEmail" placeholder="Email">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btn-signin").click(function() {
                ...
                //ajax.post
                global.ajaxPost(url, data, function(resultDataLogin) {
                    console.log(resultDataLogin);

                    if (resultDataLogin['logged_in'] == false) {
                        alert("Username / Password salah");
                    } else {
                        window.location = base_url + resultDataLogin['url'];
                    }
